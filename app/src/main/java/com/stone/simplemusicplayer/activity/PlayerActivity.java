...
public class PlayerActivity extends AppCompatActivity implements CloseMusic {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer media) {
                ++position;
                mediaPlayer=media;
                mediaPlayer=MediaPlayer.create(PlayerActivity.this, Uri.parse(songs.get(position).getUrl()));
                mediaPlayer.start();
